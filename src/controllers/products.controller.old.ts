...
export class ProductsController {
  ...
  public async getUpgradeOptions(@Param('productId') productId: string): Promise<CustomResult> {
    ...
    try {
          ...
          : [
              {
                ...
                currentPrice: 999,
                newPrice: 1999,
                features: ['unlimited_storage', '24_7_support', 'advanced_analytics'],
                savings: 'Get 2x more features',
              },
            ];
      ...
      this._Logger.error(`Failed to get upgrade options: ${error.message}`, error.stack);
      throw new HttpException('Failed to get upgrade options', HttpStatus.INTERNAL_SERVER_ERROR);
    }
  }
}
